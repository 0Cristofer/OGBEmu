...
class CpuIncDecInstructionsTest : public BaseTest
{
public:
    CpuIncDecInstructionsTest();
...
private:
    // Test categories
    void TestIncrement8Bit();
    void TestDecrement8Bit();
    void TestIncrement16Bit();
    void TestDecrement16Bit();
    void TestIncrementMemory();
    void TestDecrementMemory();
    void TestIncrementFlags();
    void TestDecrementFlags();
    ...
    void VerifyFlag(bool expected, bool actual, const char* flagName);
