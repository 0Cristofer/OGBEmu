...
class CpuDaaInstructionTest : public BaseTest
{
public:
    CpuDaaInstructionTest();
...
private:
    // Test categories
    void TestDaaAfterAddition();
    void TestDaaAfterSubtraction();
    void TestDaaWithCarryFlag();
    void TestDaaWithHalfCarryFlag();
    void TestDaaEdgeCases();
    void TestDaaZeroFlag();
    void TestDaaDecimalArithmetic();
