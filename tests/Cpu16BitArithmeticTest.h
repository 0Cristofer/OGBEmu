...
class Cpu16BitArithmeticTest : public BaseTest
{
public:
    Cpu16BitArithmeticTest();
...
private:
    ...
    void TestAddHlHl();
    void TestAddHlSp();
    void TestAddHlCarryBehavior();
    void TestAddHlFlagBehavior();
    void TestAddHlOverflow();
    void TestAddSpE8();
    ...
    void VerifyMemoryValue16(word address, word expected, const char* description);
