...
private:
    void TestOamBasicReadWrite();
    void TestOamAddressTranslation();
    void TestOamBoundaryConditions();
    void TestOamSpriteAttributes();
    void TestOamSpritePositions();
    void TestOamTileIndices();
    void TestOamAttributeFlags();
    void TestOamConstants();
    
    void VerifyOamValue(word address, byte expected, const std::string& testName);
