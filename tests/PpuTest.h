...
private:
    ...
    void TestLcdDisabled();
    void TestScanlineTimingBasic();
    void TestScanlineOverflow();
    void TestVBlankTiming();
    void TestLcdYRegisterUpdate();
    void TestPpuConstants();
    
    // Helper methods
    void VerifyLcdY(byte expected, const std::string& testName);
