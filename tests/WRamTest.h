...
class WRamTest : public BaseTest
{
public:
    WRamTest();
...
private:
    void TestWRamBasicReadWrite();
    void TestWRamAddressTranslation();
    void TestWRamBoundaryConditions();
    void TestWRamProgramStorage();
    void TestWRamStackOperations();
    void TestWRamVariableStorage();
    void TestWRamConstants();
    
    void VerifyWRamValue(word address, byte expected, const std::string& testName);
