...
class CpuStopInstructionTest : public BaseTest
{
public:
    CpuStopInstructionTest();
...
private:
    // Test categories
    void TestStopBasicBehavior();
    void TestStopWithFollowingInstructions();
    void TestStopResumeConditions();
    void TestStopTiming();
