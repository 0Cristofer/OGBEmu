...
class CpuJumpInstructionsTest : public BaseTest
{
public:
    CpuJumpInstructionsTest();
...
private:
    void TestJrInstruction();
    void TestJpInstruction();
    void TestBasicCallRet();
    void TestJrConditional();
    void TestJpConditional();
    void TestJpHl();
    void TestCall();
    void TestCallConditional();
    void TestRet();
    void TestRetConditional();
    void TestRst();
    void TestReti();
