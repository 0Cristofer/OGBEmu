...
class HRamTest : public BaseTest
{
public:
    HRamTest();
...
private:
    void TestHRamBasicReadWrite();
    void TestHRamAddressTranslation();
    void TestHRamBoundaryConditions();
    void TestHRamFastAccess();
    void TestHRamStackPointer();
    void TestHRamInterruptHandling();
    void TestHRamConstants();
    
    void VerifyHRamValue(word address, byte expected, const std::string& testName);
