...
class CpuRotateInstructionsTest : public BaseTest
{
public:
    CpuRotateInstructionsTest();
...
private:
    // Test categories
    void TestRotateLeftCircularA();
    void TestRotateRightCircularA();
    void TestRotateLeftA();
    void TestRotateRightA();
    void TestRotateCarryBehavior();
    void TestRotateZeroFlag();
    void TestRotateSequences();
